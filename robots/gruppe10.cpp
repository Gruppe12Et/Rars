...
public:
  ...
  double corn_spd(double radius)  // returns maximum cornering speed, fps
  {
    ...
    return sqrt(radius * 27.2 * CORN_MYU);     // compute the speed
  }
